...
# NOTE: Kafka advertised listener update is handled by deploy-complete.sh
# This avoids SSH connection issues during terraform apply and allows for
# more flexible deployment options (with or without SSH key)
