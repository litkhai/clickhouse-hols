...
echo ""
echo "📦 Setting up ClickHouse version 25.1..."
./set.sh 25.1

echo ""
echo "▶️  Starting ClickHouse 25.1..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 25.1 installation..."
...
echo ""
echo "✅ ClickHouse 25.1 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-auto-minmax-index.sh"
echo "   ./02-merge-variant-schema.sh"
echo "   ./03-new-functions.sh"
echo ""
