...
echo ""
echo "▶️  Starting ClickHouse 25.3..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 25.3 installation..."
...
echo ""
echo "✅ ClickHouse 25.3 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-new-functions.sh"
echo "   ./02-query-condition-cache.sh"
echo "   ./03-estimate-compression-ratio.sh"
echo ""
