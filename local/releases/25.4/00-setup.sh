...
echo ""
echo "📦 Setting up ClickHouse version 25.4..."
./set.sh 25.4

echo ""
echo "▶️  Starting ClickHouse 25.4..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 25.4 installation..."
...
echo ""
echo "✅ ClickHouse 25.4 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-array-distance-functions.sh"
echo "   ./02-sparsegrams.sh"
echo "   ./03-tointerval-and-db-comments.sh"
echo ""
