...
echo ""
echo "📦 Setting up ClickHouse version 26.7..."
./set.sh 26.7

echo ""
echo "▶️  Starting ClickHouse 26.7..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 26.7 installation..."
...
echo ""
echo "✅ ClickHouse 26.7 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-explain-analyze.sh"
echo "   ./02-at-time-zone.sh"
echo "   ./03-groupformat-tuple.sh"
echo ""
