...
# ClickHouse 26.1 Setup Script
# Purpose: Deploy ClickHouse 26.1 using oss-mac-setup and verify installation
...
# Run setup with version 26.1 (single version uses default ports)
echo "📦 Setting up ClickHouse version 26.1..."
./set.sh 26.1

echo ""
echo "▶️  Starting ClickHouse 26.1..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 26.1 installation..."
...
echo ""
echo "✅ ClickHouse 26.1 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   Run feature test scripts in order:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-reverse-by-separator.sh"
echo "   ./02-text-index-arrays.sh"
echo "   ./03-keeper-http-api.sh"
echo ""
