...
echo ""
echo "📦 Setting up ClickHouse version 25.2..."
./set.sh 25.2

echo ""
echo "▶️  Starting ClickHouse 25.2..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 25.2 installation..."
...
echo ""
echo "✅ ClickHouse 25.2 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-parquet-bloom-filters.sh"
echo "   ./02-backup-database-engine.sh"
echo "   ./03-functions-and-progress-formats.sh"
echo ""
