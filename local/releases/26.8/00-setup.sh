...
echo ""
echo "📦 Setting up ClickHouse version 26.8..."
./set.sh 26.8

echo ""
echo "▶️  Starting ClickHouse 26.8..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 26.8 installation..."
...
echo ""
echo "✅ ClickHouse 26.8 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-pipe-operators.sh"
echo "   ./02-groups-window-frame.sh"
echo "   ./03-cjk-tokenizers.sh"
echo ""
