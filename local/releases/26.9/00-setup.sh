...
echo ""
echo "📦 Setting up ClickHouse version 26.9..."
./set.sh 26.9

echo ""
echo "▶️  Starting ClickHouse 26.9..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 26.9 installation..."
...
echo "   🆕 SQL Console (new in 26.9): http://localhost:8123/ui"
...
echo ""
echo "✅ ClickHouse 26.9 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-limit-after-until.sh"
echo "   ./02-keyvaluepairs-index.sh"
echo "   ./03-zstd-default.sh"
echo "   ./04-create-token.sh"
echo ""
