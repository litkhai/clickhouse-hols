...
echo ""
echo "📦 Setting up ClickHouse version 26.5..."
./set.sh 26.5

echo ""
echo "▶️  Starting ClickHouse 26.5..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 26.5 installation..."
...
echo ""
echo "✅ ClickHouse 26.5 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-filesystem-function.sh"
echo "   ./02-higher-order-primes.sh"
echo "   ./03-tokenize-highlight-query.sh"
echo ""
