...
# ClickHouse 25.12 Setup Script
# Purpose: Deploy ClickHouse 25.12 using oss-mac-setup and verify installation
...
# Run setup with version 25.12 (single version uses default ports)
echo "📦 Setting up ClickHouse version 25.12..."
./set.sh 25.12

echo ""
echo "▶️  Starting ClickHouse 25.12..."
./start.sh
...
echo ""
echo "✅ Verifying ClickHouse 25.12 installation..."
...
echo ""
echo "✅ ClickHouse 25.12 setup complete!"
echo ""
echo "🎯 Next Steps:"
echo "   Run feature test scripts in order:"
echo "   cd $SCRIPT_DIR"
echo "   ./01-hmac-function.sh"
echo "   ./02-naive-bayes-classifier.sh"
echo "   ./03-join-optimization.sh"
echo ""
